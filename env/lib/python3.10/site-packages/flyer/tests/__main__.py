...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser('Flyer')
...
def main(args=None):
    """
    Called with ``python -m flyer.tests``: run main test suite.
    """
    ...
    import flyer.tests as test_module
